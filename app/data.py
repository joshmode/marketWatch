...
async def fetch_data(ticker: str = "^GSPC", period: str = "2y", interval: str = "1d") -> pd.DataFrame:
    ...
    async with httpx.AsyncClient() as client:
        for url in endpoints:
            try:
                ...
                response = await client.get(url, params=params, headers=request_headers(), timeout=15)
